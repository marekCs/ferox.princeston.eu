...
/**
 * Owl Carousel 2 Add Image Form Class.
 */
class OwlCarousel2AddImageForm extends OwlCarousel2AddItemForm {
  ...
  public function submitForm(array &$form, FormStateInterface $form_state, OwlCarousel2 $carousel = NULL) {
    ...
    $navigation_image_id = $navigation_image_id[0] ?? NULL;
    ...
    if (!empty($current_item['file_id']) && $current_item['file_id'] !== $file_id) {
      OwlCarousel2Util::changeFile($file_id, $carousel, $current_item['file_id']);
    }
    ...
    if ($navigation_image_id && !isset($current_item['navigation_image_id']) || (isset($current_item['navigation_image_id']) && $current_item['navigation_image_id'] != $navigation_image_id) && $navigation_image_id) {
      $previous = $current_item['navigation_image_id'] ?? 0;
      OwlCarousel2Util::changeFile($navigation_image_id, $carousel, $previous);
    }
