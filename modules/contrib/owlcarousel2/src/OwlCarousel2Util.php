...
/**
 * Owl Carousel 2 Utility Class.
 */
class OwlCarousel2Util {
  ...
  public static function getCarouselData($owlcarousel_id) {
    ...
    $isTextNavigation = isset($settings['textNavigation']) && $settings['textNavigation'] == 'true';
  ...
  private static function prepareImageCarousel(array $item, OwlCarousel2 $carousel) {
    ...
    $nav_width = 0;
    $settings = $carousel->getSettings();
    $is_text_navigation = isset($settings['textNavigation']) && $settings['textNavigation'] == 'true';
    ...
    $node_render_array['#attributes']['title_color'] = $item['title_color'] ?? '';
    $node_render_array['#attributes']['content_color'] = $item['content_color'] ?? '';
    $node_render_array['#attributes']['background_color'] = $item['background_color'] ?? '';
  ...
  private static function getNavigationInfo(array $item, OwlCarousel2 $carousel) {
    ...
    $nav_style_name = $settings['carouselNavigationImageStyle'] ?? 'thumbnail';
    $nav_ratio = 1;
    $file = NULL;
