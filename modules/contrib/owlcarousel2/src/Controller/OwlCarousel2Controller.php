...
class OwlCarousel2Controller extends ControllerBase implements ContainerInjectionInterface {
   ...
   */
  public function revisionShow($owlcarousel2_revision): array {
    $owlcarousel2 = $this->entityTypeManager()
      ->getStorage('owlcarousel2')
      ->loadRevision($owlcarousel2_revision);
    $view_builder = $this->entityTypeManager()->getViewBuilder('owlcarousel2');
   ...
   * @throws \Drupal\Component\Plugin\Exception\PluginNotFoundException
   */
  public function revisionPageTitle($owlcarousel2_revision): string {
    $owlcarousel2 = $this->entityTypeManager()
      ->getStorage('owlcarousel2')
      ->loadRevision($owlcarousel2_revision);
   ...
   * @throws \Drupal\Component\Plugin\Exception\PluginNotFoundException
   */
  public function revisionOverview(OwlCarousel2Interface $owlcarousel2): array {
    ...
    $owlcarousel2_storage = $this->entityTypeManager()
      ->getStorage('owlcarousel2');
    ...
    foreach (array_reverse($vids) as $vid) {
      /** @var \Drupal\owlcarousel2\Entity\OwlCarousel2 $revision */
